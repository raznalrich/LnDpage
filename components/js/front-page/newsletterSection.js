...
// shownewsletter();
const eventContainer = document.getElementById("inner-div");
...
window.getCalendarImage = async function () {
    ...
    try {
        ...
        if (snapshot.exists()) {
            ...
            const preview = document.getElementById("rightcalendar");
            const button = document.getElementById("newsletter-button")
            preview.innerHTML = `<a href="./NewsletterSapperatePage.html" target="_top"><img src="${data[1].htmlurl}" style="width:625px;height:300px;object-fit: cover;object-position: top;" /></a>`;
            button.innerText = `${data[1].date}`
